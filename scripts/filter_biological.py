...
def main():
    ...
    col_tdepth = pick(df, "t_depth", "t_depth_func")          # optional
    col_vaf    = pick(df, "VAF", "VAF_func")                  # optional
    ...
    if col_sift:
        ...
        # Text-only SIFT scoring: ignore numeric threshold entirely.
        sift_strong = sift_del
